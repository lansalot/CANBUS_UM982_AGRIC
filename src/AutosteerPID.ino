...
void motorDrive(void)
{
  ...
  if (Brand == 3)
    setCurve = setCurve - (pwmDrive * 10); // Fendt hurry up becasue we are using full 16bit scale.
  else if (Brand == 5)
    setCurve = setCurve - (pwmDrive * 10); // FendtOne hurry up becasue we are using full 16bit scale.
  else
