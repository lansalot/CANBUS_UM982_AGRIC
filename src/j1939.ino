...
void sendISOBUS_129029()
{
	...
	n2k_fastPackets.buf[4] = N2K_129029_Data[23];
	; // Altitude x8
	...
	n2k_fastPackets.buf[5] = N2K_129029_Data[38];
	; // 4 byte double, GeoidalSeparation
	...
	if (frameCount++ > 7)
		frameCount = 0; // We can only use 3 bits as the frame counter
}
